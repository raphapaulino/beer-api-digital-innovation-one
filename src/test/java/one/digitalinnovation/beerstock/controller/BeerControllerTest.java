...
public class BeerControllerTest {
    ...
    @Test
    void whenDELETIsCalledWithValidIdThenNoContentStatusIsReturned() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void whenDELETIsCalledWithInvalidIdThenNotFoundStatusIsReturned() throws Exception {
        // when
